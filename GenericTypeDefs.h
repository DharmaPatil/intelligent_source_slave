...
typedef union
{
    ...
    struct
    {
        __EXTENSION UINT8 NULL0:1;
        __EXTENSION UINT8 NULL1:1;
        __EXTENSION UINT8 NULL2:1;
        __EXTENSION UINT8 NULL3:1;
        __EXTENSION UINT8 NULL4:1;
        __EXTENSION UINT8 NULL5:1;
        __EXTENSION UINT8 NULL6:1;
        __EXTENSION UINT8 NULL7:1;
    } bits;
} FlagAA;
...
typedef union
{
    ...
    struct
    {
        __EXTENSION UINT8 Light:1;
        __EXTENSION UINT8 Light1:1;
        __EXTENSION UINT8 SM1:1;//给主手机1定时发送短信标志位  1为待发送，0为发送完成
        __EXTENSION UINT8 SM2:1;//给主手机2定时发送短信标志位  1为待发送，0为发送完成
        __EXTENSION UINT8 NULL4:1;
        __EXTENSION UINT8 NULL5:1;
        __EXTENSION UINT8 NULL6:1;
        __EXTENSION UINT8 NULL7:1;
